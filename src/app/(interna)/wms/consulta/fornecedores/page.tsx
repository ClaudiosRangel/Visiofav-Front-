...
export default function ConsultaFornecedoresPage() {
  useModuloGuard('WMS')
  useEffect(() => { document.title = 'VisioFab - WMS - Consulta Fornecedores' }, [])
  ...
  return (
    <div>
      <Text size="xs" c="dimmed" mb={4}>WMS / Consulta / Fornecedores</Text>
      <Text size="xl" fw={600} mb="lg">Fornecedores (Consulta)</Text>

      <Alert icon={<IconLock size={16} />} color="blue" variant="light" mb="md">
        Visualização somente leitura. Para cadastrar ou editar fornecedores, acesse o módulo de Compras.
      </Alert>
      ...
      <Card pos="relative">
        ...
        <Table striped highlightOnHover>
          ...
          <Table.Tbody>
            ...
            {!isLoading && items.length === 0 && <Table.Tr><Table.Td colSpan={6} className="text-center py-8 text-zinc-500">Nenhum fornecedor cadastrado</Table.Td></Table.Tr>}
          </Table.Tbody>
        </Table>

...
const mockData = [
  { id: '1', codigo: 1, descricao: 'Alimentos', status: true },
  { id: '2', codigo: 2, descricao: 'Bebidas', status: true },
  { id: '3', codigo: 3, descricao: 'Higiene e Limpeza', status: true },
  { id: '4', codigo: 4, descricao: 'Perecíveis', status: true },
  { id: '5', codigo: 5, descricao: 'Congelados', status: true },
]
...
export default function CategoriasPage() {
  ...
  return (
    <div>
      <Text size="xs" c="dimmed" mb={4}>Início / Configurador / Categorias</Text>
      <Text size="xl" fw={600} mb="lg">Categoria de Produto</Text>
      <Card>
      ...
      <Modal opened={modalOpen} onClose={() => setModalOpen(false)} title={editItem ? 'Editar Categoria' : 'Nova Categoria'} centered closeOnClickOutside={false}>

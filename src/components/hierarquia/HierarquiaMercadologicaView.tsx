...
import {
  ...
  Select, Switch, LoadingOverlay, Tabs,
} from '@mantine/core'
...
interface Props {
  /**
   * Breadcrumb exibido no topo. Varia por módulo de origem (Compras ou WMS),
   * já que a mesma tela é compartilhada pelos dois — o resto do comportamento
   * é idêntico.
   */
  breadcrumb?: string
  /** Módulos autorizados a acessar a tela (guard). */
  modulosPermitidos?: string[]
}

/**
 * Tela de gerenciamento da Hierarquia Mercadológica. Compartilhada entre o
 * módulo Compras (rota /compras/hierarquia) e o WMS (rota
 * /configurador/hierarquia) — cada rota é um wrapper fino que renderiza este
 * componente, preservando o contexto/sidebar do módulo de origem.
 */
export default function HierarquiaMercadologicaView({
  breadcrumb = 'Hierarquia Mercadológica',

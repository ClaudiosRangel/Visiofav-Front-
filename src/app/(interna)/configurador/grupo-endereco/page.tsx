...
const mockData = [
  { id: '1', codigo: 1, descricao: 'Grupo Armazenagem Geral', status: true },
  { id: '2', codigo: 2, descricao: 'Grupo Picking', status: true },
  { id: '3', codigo: 3, descricao: 'Grupo Doca', status: true },
  { id: '4', codigo: 4, descricao: 'Grupo Avaria', status: true },
]

export default function GrupoEnderecoPage() {
  ...
  return (
    <div>
      <Text size="xs" c="dimmed" mb={4}>Início / Configurador / Grupo de Endereço</Text>
      <Text size="xl" fw={600} mb="lg">Grupo de Endereço</Text>
      <Card>
      ...
      <Modal opened={modalOpen} onClose={() => setModalOpen(false)} title={editItem ? 'Editar Grupo' : 'Novo Grupo'} centered closeOnClickOutside={false}>

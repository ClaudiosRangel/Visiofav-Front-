...
const mockData = [
  { id: '1', codigo: 1, descricao: 'Perecível', status: true },
  { id: '2', codigo: 2, descricao: 'Inflamável', status: true },
  { id: '3', codigo: 3, descricao: 'Frágil', status: true },
  { id: '4', codigo: 4, descricao: 'Controlado', status: true },
  { id: '5', codigo: 5, descricao: 'Alto Valor', status: false },
]
...
export default function CaracteristicasEstoquePage() {
  ...
  return (
    <div>
      <Text size="xs" c="dimmed" mb={4}>Início / Configurador / Características de Estoque</Text>
      <Text size="xl" fw={600} mb="lg">Características de Estoque</Text>
      <Card>
      ...
      <Modal opened={modalOpen} onClose={() => setModalOpen(false)} title={editItem ? 'Editar Característica' : 'Nova Característica'} centered closeOnClickOutside={false}>

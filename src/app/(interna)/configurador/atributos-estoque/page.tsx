...
const mockData = [
  { id: '1', codigo: 1, descricao: 'Lote', status: true },
  { id: '2', codigo: 2, descricao: 'Validade', status: true },
  { id: '3', codigo: 3, descricao: 'Número de Série', status: true },
  { id: '4', codigo: 4, descricao: 'Data de Fabricação', status: false },
]

export default function AtributosEstoquePage() {
  ...
  return (
    <div>
      <Text size="xs" c="dimmed" mb={4}>Início / Configurador / Atributos de Estoque</Text>
      <Text size="xl" fw={600} mb="lg">Atributos de Estoque</Text>
      <Card>
      ...
      <Modal opened={modalOpen} onClose={() => setModalOpen(false)} title={editItem ? 'Editar Atributo' : 'Novo Atributo'} centered closeOnClickOutside={false}>
